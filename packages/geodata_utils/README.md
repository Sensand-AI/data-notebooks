...
To create the wheels/ egg files, navigate to the parent fodler of the package (in this case geodata-package) and run:
`python setup.py bdist_wheel`. This will create a bunch of stuff and setup the build and dist folders.
